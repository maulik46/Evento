...
<div class="row justify-content-center">
    ...
    <div class="col-lg-8 col-md-10 col-sm-10 mx-2 p-0">
        ...
        <div class="bg-white new-shadow rounded-lg p-3 pb-5">
            ...
            <form class="form-horizontal" method="post" onsubmit="return getMessage()"
                action="{{url('action_update')}}/{{encrypt($e_data['eid'])}}" enctype="multipart/form-data">
                @csrf
                <div class="card border-form">
                    <div class="card-body py-0 pb-1">
                            ...
                            <div class="col-md-8 form-group mt-2 ">
                                ...
                                <div id="enamediv" class="form-group has-icon d-flex align-items-center">
                                    ...
                                    <input type="text" onkeyup="this.value = this.value.toLowerCase()" id="ename"
                                        ...
                                        value="{{$e_data['ename']}}" placeholder="Enter Event Name..." />
                                </div>
                            ...
                            <div class="col-md-4 form-group mt-2">
                                ...
                                <div>
                                    <label for="poster-upload" class="custom-file-upload rounded overflow-auto">
                                        <i id="camera" data-feather="image"></i>
                                        <span id="up" class="mx-2">Upload Poster</span>
                                    </label>
                                    <input id="poster-upload" name="poster-upload[]" type="file" multiple
                        ...
                        <div class="p-1" id="fc">
                            ...
                            <div class="p-1 rounded" style="border: 1px solid #d1d1d180; <?php if($fcount==0) { ?> display:none <?php } ?>">
                                <div class="d-flex justify-content-center align-items-center mr-2"
                                    style="margin-top:-12px;">
                                    <span class="badge badge-dark px-3 py-1 badge-pill"
                                        id="countfile">Total File {{$fcount}}</span>
                                </div>
                                <div class="mt-2 col-xl-12 row" id="fl">
                                    @foreach($att as $ban_details)
                                    @if($ban_details)
                                    <div class="alert font-weight-bold rounded-0 p-1 font-size-15 mb-1 d-flex justify-content-between align-items-center col-xl-6"
                                        style="background-color:#25c2e340;border-right:4px solid #fff;border-left:4px solid #fff;">
                                        <span class="text-dark col-8">{{substr($ban_details,10)}}</span>
                                        <button class="badge badge-danger px-3 badge-pill mr-2 col-4 border-0" id="<?php $uniq=uniqid(); echo $uniq; ?>"
                                            onclick="return rmimg('<?php echo $uniq; ?>','<?php echo encrypt($ban_details); ?>','<?php echo $e_data['eid']; ?>')">delete</button>
                                    </div>
                    ...
                    <div class="card-body py-0 pb-1">
                        <div class="row">
                            <div class="col-xl-4 form-group mt-2">
                                ...
                                <div id="edatediv" class="form-group has-icon d-flex align-items-center">
                                    ...
                                    <input type="text" id="edate" value="{{date('d/m/Y', strtotime($e_data['edate']))}}"
                                        name="edate" class="form-control basicDate" placeholder="Event Date..."
                                        data-input />
                                </div>
                                <span id="erevent" class="text-danger font-weight-bold"></span>
                            ...
                            <div class="col-xl-4 form-group mt-2">
                                ...
                                <div id="enddatediv" class="form-group has-icon d-flex align-items-center">
                                    ...
                                    <input type="text" id="enddate"
                                        value="{{date('d/m/Y', strtotime($e_data['enddate']))}}" name="enddate"
                                        class="form-control basicDate" placeholder="Event End Date..." data-input />
                                </div>
                                <span id="erevent" class="text-danger font-weight-bold"></span>
                            ...
                            <div class="col-xl-4 form-group mt-2">
                                ...
                                <div id="etimediv" class="form-group has-icon d-flex align-items-center">
                                    ...
                                    <input type="text" id="etime" name="etime"
                                        value="{{date('h:i A', strtotime($e_data['time']))}}"
                                        class="form-control timePicker" placeholder="Event Time..."
                                        autocomplete="off" />
                                </div>
                        ...
                        <div class="row">
                            <div class="col-xl-6 form-group mt-2">
                                ...
                                <div class="form-group has-icon d-flex align-items-center">
                                    ...
                                    <input type="text" id="sdate" name="sdate"
                                        value="{{date('d/m/Y', strtotime($e_data['reg_start_date']))}}"
                                        class="form-control basicDate" placeholder="Starting Date Of Registraion..."
                                        data-input />
                                </div>
                            ...
                            <div class="col-xl-6 form-group mt-2">
                                ...
                                <div class="form-group has-icon d-flex align-items-center">
                                    <i data-feather="calendar" class="form-control-icon ml-2" height="19px"></i>
                                    <input type="text" id="ldate" name="ldate"
                                        value="{{date('d/m/Y', strtotime($e_data['reg_end_date']))}}"
                                        class="form-control basicDate" placeholder="Last Date Of Registraion..."
                                        data-input />
                                </div>
                                <span class="text-danger font-weight-bold"></span>
                            </div>
                    ...
                    <div class="card-body py-0 pb-1">
                        <div class="row">
                            <div class="col-xl-4 form-group mt-2">
                                ...
                                <div class="form-group has-icon d-flex align-items-center" style="opacity: 0.5;"
                        ...
                        <div class="row">
                            <div class="col-md-4 form-group mt-2">
                                ...
                                <div id="t-size" class="form-group has-icon d-flex align-items-center"
                                    style="opacity: 0.5;" data-toggle="tooltip" data-placement="bottom"
                                    title="This field disable because some students are already participated.">
                            ...
                            <div class="col-md-4 form-group mt-sm-5 mt-2" style="opacity: 0.5;" data-toggle="tooltip"
                                ...
                                <div class="custom-control custom-switch mb-2">
                                    <input type="checkbox" name="alw_diff_class" class="custom-control-input"
                                        ...
                                        <?php if($e_data['alw_dif_class']=="yes"){ ?>checked<?php } ?> disabled>
                            ...
                            <div class="col-md-4 form-group mt-2">
                                ...
                                <div id="m-team" class="form-group has-icon d-flex align-items-center">
                                    ...
                                    <input id="max-team" name="mteam" type="number" class="form-control"
                                        value="{{$e_data['maxteam']}}" placeholder="Maximum Team" />
                                </div>
                                <span class="text-danger font-weight-bold"></span>
                        ...
                        @else
                        <?php  $class=App\tblstudent::select('class')->where('clgcode',Session::get('cclgcode'))->groupby('class')->orderby('class')->get(); ?>
                        <div class="card border-form my-3">
                            <div class="card-body py-0 pb-1">
                                <div class="row">
                                    <div class="col-md-4 form-group mt-2">
                                        ...
                                        <div class="form-group has-icon d-flex align-items-center">
                                            ...
                                            <select id="event-type" name="etype"
                                                ...
                                                <option value="solo" <?php if($e_data['e_type']=="solo"){?> selected
                                                    <?php }?>>Solo</option>
                                                <option value="team" <?php if($e_data['e_type']=="team"){?> selected
                                                    <?php }?>>Team</option>
                                            </select>
                                        </div>
                                        <span class="text-danger font-weight-bold"></span>
                                        ...
                                        <div class="form-group has-icon d-flex align-items-center">
                                            ...
                                            <select id="gen" onchange="return echeck()" name="efor"
                                                ...
                                                <option value="male" <?php if($e_data['gallow']=="male"){?> selected
                                                    <?php }?>>Male</option>
                                                <option value="female" <?php if($e_data['gallow']=="female"){?> selected
                                                    <?php }?>>Female</option>
                                                <option value="both" <?php if($e_data['gallow']=="both"){?> selected
                                                    <?php }?>>For both</option>
                                            </select>
                                        </div>
                                        <span class="text-danger font-weight-bold"></span>
                                    ...
                                    ?>
                                            <select multiple="multiple" name="class[]" class="form-control active w-100 py-1"
                                                ...
                                                <option value="{{$cls['class']}}" selected>{{ucfirst($cls['class'])}}
                                                </option>
                                                @else
                                ...
                                <div class="row">
                                    <div class="col-md-4 form-group mt-2">
                                        ...
                                        <div id="t-size" class="form-group has-icon d-flex align-items-center">
                                            <i data-feather="user-plus" class="form-control-icon ml-2"
                                                height="19px"></i>
                                            <input id="team-size" name="tsize" type="number" class="form-control"
                                    ...
                                    <div class="col-md-4 form-group mt-sm-5 mt-2">
                                        <div class="custom-control custom-switch mb-2">
                                            <input type="checkbox" name="alw_diff_class" class="custom-control-input"
                                                id="diff-class" value="yes"
                                                <?php if($e_data['alw_dif_class']=="yes"){ ?>checked<?php } ?>>
                                            <label class="custom-control-label" for="diff-class"
                                                id="diff-class-label">Allow
                                                Different Class</label>
                                        </div>
                                        <div class="custom-control custom-switch mb-2">
                                            <input type="checkbox" name="alw_diff_div" value="yes"
                                                class="custom-control-input" id="diff-div"
                                                <?php if($e_data['alw_dif_div']=="yes"){ ?> checked<?php } ?>>
                                            <label class="custom-control-label" for="diff-div" id="diff-div-label">Allow
                                                Different Division</label>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-xl-12 form-group mt-2">
                                        ...
                                        <div class="form-group has-icon d-flex align-items-center">
                                            ...
                                            <input id="loc" type="text" name="loc" class="form-control"
                                                value="{{$e_data['place']}}" placeholder="Event Location..." />
                                        </div>
                                        <span class="text-danger font-weight-bold"></span>
                                    </div>
                                </div>
                            ...
                            <div class="card-body py-0 pb-1">
                                <div class="form-group mt-2">
                                    ...
                                    <div class="form-group has-icon d-flex align-items-center">
                                        ...
                                        <input type="text" style="background-color: #f3f4f7;color: #737373!important;"
                                            class="form-control font-size-15 font-weight-bold" disabled
                                            value="{{ucfirst(Session::get('cname'))}}" />
                                    </div>
                                </div>
                                <div class="form-group mt-2">
        ...
        if ($('#poster-upload').val() != "") {
            ...
            if (fi.files.length > 0) {
                ...
                for (var i = 0; i <= fi.files.length - 1; i++) {
                    ...
                    if (ext == "JPEG" || ext == "jpeg" || ext == "jpg" || ext == "JPG" || ext == "svg" || ext ==
                        "SVG" || ext == "png" || ext == "PNG") {
                        if (size > 2048) {
                            ...
                            document.getElementById('fl').innerHTML =
                                document.getElementById('fl').innerHTML +
                                '<div class="alert font-weight-bold rounded-0 p-1 font-size-15 mb-1 d-flex justify-content-between align-items-center col-xl-6" style="background-color:orange;border-right:4px solid #fff;border-left:4px solid #fff;"> <span class="text-dark col-8">' +
                                fname + '</span><span class="badge badge-light px-3 badge-pill mr-2 col-4">' + (
                                    fsize / 1024).toFixed(2) + 'KB</span></div>';
                            dcount = dcount + 1;
                        } else {
                            $('#validphoto').text("");
                            document.getElementById('fl').innerHTML =
